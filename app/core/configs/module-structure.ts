                    ...
                    children: [
                        {
                            name: 'test',
                            ruleId: 'subFolder',
                            children: [{ name: '*.test.ts', ruleId: 'testFile' }],
                        },
...
export default {
    files: ['app/modules/**'], // ← применяем только к модулям
    ...
    rules: {
        'project-structure/folder-structure': [
            'error',
            {
                ...
                structureRoot: './app/modules', // ← ключевой момент — откуда считать структуру
            },
        ],
    },
